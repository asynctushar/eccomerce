...
import { getProductReviewsAction, deleteProductReviewAction, clearDeleteReviewStatusAction } from '../../../redux/actions/productAction';


const ReviewList = () => {
    const [productId, setProductId] = useState('');
    const { productReviews: reviews, isReviewDeleted } = useSelector((state) => state.productState);
    ...
    const productReviewsSubmitHandler = (e) => {
        ...
        if (productId.length !== 24) {
            return alert.error('Product Id characters should be 24 in length.')
        }
