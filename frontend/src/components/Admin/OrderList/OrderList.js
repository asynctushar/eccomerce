...
import { clearDeleteOrderStatusAction, deleteOrderAction, getAllOrdersAction } from '../../../redux/actions/orderAction';

const OrderList = () => {
    const alert = useAlert();
    const navigate = useNavigate();
    const dispatch = useDispatch();
    const { allOrders, deleteOrderStatus } = useSelector(state => state.orderState);
        ...
        <Fragment>
            ...
            <div className="dashboard">
                ...
                <div className="orderlist-container">
                    ...
                    <DataGrid rows={rows} columns={columns} autoHeight disableSelectionOnClick pageSize={10} rowsPerPageOptions={[10]} className="orderlist-table" />
                </div>
            </div>
        </Fragment>
    )
